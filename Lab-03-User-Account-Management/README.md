...
- Created new user: James Hart (jhart)
...
- Right clicked jhart and selected Disable Account
...
- Right clicked jhart and selected Enable Account
...
- Right clicked jhart and selected Reset Password
...
- Opened jhart Properties → Account tab
...
- Moved jhart from IT OU to HR OU
- Confirmed jhart appeared in HR OU
- Moved jhart back to IT OU
- Simulated an employee changing departments

### Task 7 — Add and Remove User from Security Group
- Right clicked jhart and selected Add to a group
- Added jhart to IT-Admins security group
- Confirmed via group Members tab that jhart was listed
- Removed jhart from IT-Admins group
- Simulated granting and revoking elevated permissions

### Task 8 — Delete a User Account
- Right clicked jhart and selected Delete
- Confirmed deletion via dialog prompt
- Verified jhart no longer appeared in IT OU
